    ...
    try {
      ...
      await client.query(
        `INSERT INTO gold_scheme_payments
           (member_id, month_number, paid_date, amount, payment_mode, proof_key, transaction_id, cash_amount, bank_amount, gpay_amount, entered_by)
  ...
  async addPayment(
    ...
    try {
      ...
      const result = await client.query(
        `INSERT INTO gold_scheme_payments
           (member_id, month_number, paid_date, amount, payment_mode, proof_key, transaction_id, cash_amount, bank_amount, gpay_amount, notes, entered_by)
        ...
        [memberId, payload.monthNumber, payload.paidDate, payload.amount, payload.paymentMode,
          ...
          // cash_bank/cash_gpay share the cash portion column; bank_amount for cash_bank only
