            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <PasswordInput
                  ...
                  leftIcon={<Key size={18} className="text-navy/20" />}
                  className="w-full pl-12 py-3.5 bg-white border border-border rounded-xl text-navy placeholder:text-navy/20 focus:ring-2 focus:ring-indigo/20 focus:border-indigo/20 transition-all font-bold outline-none"
