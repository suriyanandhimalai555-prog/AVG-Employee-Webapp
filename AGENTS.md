# AGENTS.md — EMS Employee Management System

This file provides guidance to Codex when working 
...
Use /browse for all web browsing. Use ~/.Codex/skills/gstack/... for gstack file paths.
